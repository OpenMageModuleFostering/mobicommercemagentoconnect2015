...
class Mobicommerce_Mobiservices_Model_Catalog_Catalog extends Mobicommerce_Mobiservices_Model_Abstract {
    ...
    public function productInfo($data)
    {
        ...
        $productInfo = Mage::getModel('mobiservices/custom')->getCustomProductDetailFields($product, $productInfo);
        ...
        if (count($productInfo)) {
            ...
            $information['data']['product_details']['ratingOptions'] = Mage::getModel('mobiservices/review')->_getRatingOptions(array(
				"product_id" => $product_id,
				));
            if(isset($data['addRecentViews']) && $data['addRecentViews'] == '1'){
