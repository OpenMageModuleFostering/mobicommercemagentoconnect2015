...
class Mobicommerce_Mobiservices_Model_Config extends Mobicommerce_Mobiservices_Model_Abstract {
	...
	public function getAllInitialData($data)
    {
        ...
        $information['data']['appinfo']          = Mage::getModel('mobiservices/appsetting')->getAppinfo($data);
        ...
        $information['data']['categories']       = Mage::getModel('mobiservices/catalog_catalog')->_categoryTreeList($store_id, $data['appcode']);
        $information['data']['homedata']         = Mage::getModel('mobiservices/home')->_getHomeData($data);
        $information['data']['CMS']              = Mage::getModel('mobiservices/appsetting')->getCmsdata($data);
        $information['data']['language']         = Mage::getModel('mobiservices/language')->getLanguageData($storeInfo['store_info']['locale_identifier']);
        $information['data']['push']             = Mage::getModel('mobiservices/appsetting')->getPushdata($data);
        $information['data']['popup']            = Mage::getModel('mobiservices/appsetting')->getPopupdata($data);
        $information['data']['countries']        = $this->_getCounties();
        $information['data']['cart_details']     = Mage::getModel('mobiservices/shoppingcart_cart')->getCartInfo($data);

        $logged_user = null;
        if(Mage::getSingleton('customer/session')->isLoggedIn()){
            $_customer = Mage::getSingleton('customer/session')->getCustomer();
            $model = Mage::getModel('mobiservices/user');
