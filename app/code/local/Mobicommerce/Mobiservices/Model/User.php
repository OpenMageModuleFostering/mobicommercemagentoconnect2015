...
class Mobicommerce_Mobiservices_Model_User extends Mobicommerce_Mobiservices_Model_Abstract {
	...
	public function signIn($data){
        ...
        try {
            ...
            $information['data']['cart_details'] = Mage::getModel('mobiservices/shoppingcart_cart')->getCartInfo(); 
