...
$installer->run("
  ...
  DROP TABLE IF EXISTS {$this->getTable('mobicommerce_category_icons')};
  ...
  INSERT INTO {$this->getTable('mobicommerce_category_icons')} (`mci_name`, `mci_display_name`, `mci_icon_group`) VALUES 
